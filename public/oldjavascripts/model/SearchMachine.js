(function(win, doc, $, undefined){
	"use strict";	
	var BMAP = win.BMAP || {},
		PLAYLIST_QUERY_URL = "http://gdata.youtube.com/feeds/api/playlists/snippets?q=%s&v=2&alt=json",
	...
	var SearchMachine = function(){
		...
		BMAP.Mediator.subscribe("getVideoFromId", getVideoFromId.bind(this));
		BMAP.Mediator.subscribe("loadPlaylists", loadPlaylists.bind(this));
		BMAP.Mediator.subscribe("loadVideos", loadVideos.bind(this));
	};
