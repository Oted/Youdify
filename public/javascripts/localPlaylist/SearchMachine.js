(function(win, doc, $, undefined){
	...
	var SINGLE_VIDEO_URL = "https://gdata.youtube.com/feeds/api/videos/%s?v=2&alt=json"
	...
	SearchMachine.prototype.getVideoFromId = function(id, callback){
		var that = this,
	...
	SearchMachine.prototype.loadVideos = function(query, callback){
		...
		$.getJSON(url, function(data) {
			$.each(data.feed.entry, function(i, item){
				that.harvestData(item, callback);
			});
		});
	};
